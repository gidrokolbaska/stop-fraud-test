        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Obx(
                () => Expanded(
                  child: _blacklistWhitelistController.blackListSites.isEmpty
                      ? Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Add a link to the site you want to block',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontSize: 13.0,
                      ...
                      : ElementsListView(
                          ...
                          list: _blacklistWhitelistController.blackListSites,
                          listName: 'blacklistSites',
                        ),
                ),
              ),
              Container(
                        ...
                        return Theme(
                          ...
                          child: CupertinoAlertDialog(
                            ...
                            content: Column(
                              ...
                              children: [
                                const Text(
                                    'Paste the link to the site you want to block'),
